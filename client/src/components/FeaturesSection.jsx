      ...
      <div className="container">
        ...
        <div className="row g-4">
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card course-card w-100 shadow-sm border-0">
              <div className="card-body d-flex flex-column text-center p-4">
                ...
                <Link to="/register" className="btn btn-primary mt-auto">Register New Visit</Link>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card course-card w-100 shadow-sm border-0">
              <div className="card-body d-flex flex-column text-center p-4">
                ...
                <a href="#" className="btn btn-outline-primary mt-auto">Manage Status</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card course-card w-100 shadow-sm border-0">
              <div className="card-body d-flex flex-column text-center p-4">
                ...
                <a href="#" className="btn btn-outline-primary mt-auto">Add Notes</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card course-card w-100 shadow-sm border-0">
              <div className="card-body d-flex flex-column text-center p-4">
                ...
                <a href="#" className="btn btn-outline-primary mt-auto">View Dashboard</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card course-card w-100 shadow-sm border-0">
              <div className="card-body d-flex flex-column text-center p-4">
                <i className="bi bi-geo-alt text-danger d-block mx-auto mb-3" style={{ fontSize: '3rem' }}></i>
                <h5 className="card-title fw-bold">Route Optimization</h5>
                <p className="card-text flex-grow-1">Optimize your daily routes and track travel time between multiple technical visit locations.</p>
                <a href="#" className="btn btn-outline-primary mt-auto">Plan Routes</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 d-flex align-items-stretch">
            <div className="card course-card w-100 shadow-sm border-0">
              <div className="card-body d-flex flex-column text-center p-4">
                ...
                <a href="#" className="btn btn-outline-primary mt-auto">Generate Reports</a>
              </div>
            </div>
          </div>
        </div>
